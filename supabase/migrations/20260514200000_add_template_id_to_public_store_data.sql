-- Add template_id to get_public_store_data + demo so anonymous visitors
-- receive the chosen template_id without needing direct RLS access to tenant_settings.
