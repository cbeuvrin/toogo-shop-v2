...
export const SimpleLiveTemplate = (props: any) => {
    ...
    const handleNavigate = (path: string, params: Record<string, string> = {}) => {
        ...
        if (host) {
            ...
            console.warn("SimpleLiveTemplate: No host param found during navigation!");
        }
        ...
        console.log(`SimpleLiveTemplate: Navigating to ${fullPath}`);
        navigate(fullPath);
    };
    ...
    console.log("SimpleLiveTemplate props.featuredProducts:", props.featuredProducts);
    console.log("SimpleLiveTemplate props.products count:", products?.length);
    console.log("SimpleLiveTemplate first product sample:", products?.[0]);
    console.log("SimpleLiveTemplate products with features:", products?.filter((p: any) => p.features && p.features.length > 0));

    // Filter products logic similar to other templates
    ...
    return (
        <div className="min-h-screen font-sans text-black" style={{ backgroundColor: settings?.store_background_color || '#ffffff' }}>
            ...
            {(announcement?.enabled !== false) && (
                <div className="bg-gray-100 py-2 text-center text-xs font-semibold tracking-wide">
            ...
            <div className="relative w-full aspect-[4/3] md:aspect-[21/9] bg-gray-200 overflow-hidden" >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-8 md:p-16">
                    <h1 className="text-white text-4xl md:text-6xl font-extrabold uppercase mb-4 max-w-2xl leading-tight">
                        {props.welcomeTitle || settings?.welcome_title || "Para Nuestros Atletas Híbridos"}
                    </h1>
                    <p className="text-white/90 text-sm md:text-lg mb-8 max-w-xl font-medium">
            ...
            {/* Category Navigation Bar - Only on Catalog View */}
            {isCatalog && (
                ...
                isCatalog ? (
                    ...
                    <>
                        ...
                        <div className="container mx-auto px-6 py-12 flex items-end justify-between">
                            <div>
                                <h2 className="text-3xl font-extrabold uppercase mb-2">Recién Llegados</h2>
                                <button onClick={() => handleNavigate('/catalogo')} className="text-sm font-semibold underline underline-offset-4 hover:text-gray-600">Ver todo</button>
                            </div>
                                        ...
                                        <div key={product.id} className="w-[280px] md:w-[320px] group cursor-pointer" onClick={() => addToCart(product)}>
                                            <div className="relative aspect-[3/4] bg-gray-100 rounded-sm overflow-hidden mb-4">
                                                ...
                                                <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
                                                    <Button className="w-full bg-white/90 text-black hover:bg-white font-bold backdrop-blur-sm">
                                                        Quick Add +
                                                    </Button>
                                                </div>
                                            </div>
                                ...
                                <section className="py-10">
                                    <div className="w-full h-[60vh] md:h-[80vh] bg-gray-900 relative">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 z-10">
                                            ...
                                            <Button className="bg-white text-black text-lg px-10 py-7 rounded-full font-bold hover:scale-105 transition-transform">
                                                Ver Colección
                                            </Button>
                                        </div>
                                    </div>
                        ...
                        <div className="container mx-auto px-6 py-20" id="popular-grid">
                            <h2 className="text-3xl font-extrabold uppercase mb-8">Popular en este momento</h2>
                                ...
                                {(props.featuredProducts && props.featuredProducts.length > 0) ? (
                                    props.featuredProducts.map((productId: string) => {
                                        ...
                                        if (props.products && props.products.length > 0) {
                                            console.log("First product sample:", props.products[0]);
                                        }
                ...
                <div className="h-full flex flex-col">
                    ...
                    {cartItems.length > 0 && (
                        <div className="p-6 md:p-8 bg-zinc-50 border-t border-zinc-200">
                            ...
                            <Button className="w-full bg-black text-white hover:bg-zinc-800 font-bold uppercase rounded-full py-7 text-lg shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                                Finalizar Compra
                            </Button>
