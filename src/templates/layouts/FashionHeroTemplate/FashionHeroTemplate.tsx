    ...
    return (
        <div className="min-h-screen font-sans text-black" style={{ backgroundColor: settings?.store_background_color || '#ffffff' }}>
            ...
            <section className="w-full flex flex-col lg:flex-row min-h-[70vh]">
                ...
                {/* Text Side */}
                <div className="w-full lg:w-2/5 flex flex-col justify-center px-8 md:px-14 py-16 bg-white">
                    <p className="text-xs font-bold uppercase tracking-[0.25em] text-gray-400 mb-6">
                        {settings?.store_name || "Nueva Colección"}
                    </p>
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-[0.95] mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Button
                            className="bg-black text-white hover:bg-gray-800 font-bold rounded-none px-10 py-6 text-xs uppercase tracking-widest group"
                        ...
                        <Button
                            variant="outline"
                            className="border-black text-black hover:bg-black hover:text-white rounded-none px-10 py-6 text-xs uppercase tracking-widest transition-colors"
                            onClick={() => handleNavigate('/catalogo')}
                        >
                            Novedades
                        </Button>
