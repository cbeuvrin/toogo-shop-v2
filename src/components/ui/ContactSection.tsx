...
export const ContactSection: React.FC<ContactSectionProps> = ({
  ...
  // Texto del footer auto-adaptado al fondo (evita texto invisible sobre bg oscuro)
  const col = hasCustomBg ? footerTextColors(backgroundColor as string) : null;
  const textColor = col ? col.text : iconColor;
  const mutedColor = col ? col.muted : '#6b7280';
  ...
  return <section 
    ...
    >
      <div className="container mx-auto px-4">
        ...
        {/* Social Media Links */}
        {(contactData.facebook || contactData.instagram) && <div className="flex justify-center items-center space-x-6 mt-8 pt-8 border-t" style={{ borderColor: col ? col.border : undefined }}>
            {contactData.facebook && <a href={contactData.facebook} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity duration-300" style={{ color: mutedColor }}>
            ...
            {contactData.instagram && <a href={contactData.instagram} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity duration-300" style={{ color: mutedColor }}>
            ...
            {contactData.twitter && <a href={contactData.twitter} target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity duration-300" style={{ color: mutedColor }}>
