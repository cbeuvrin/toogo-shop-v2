        ...
        <header className="site-header">
          <nav className="navbar">
            <a href="#" className="logo" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
              <img src={`${A}/mascota.webp`} alt="" className="logo-toogi" />
          ...
          <section className="hero" ref={heroRef}>
            <div className="hero-content">
              <div className="hero-copy">
                ...
                <h1 className="hero-title reveal hero-r1">Tu tienda en línea gratis,<br /><span className="hero-line2">manejada desde <span className="wa-nowrap"><span className="wa-word">WhatsApp</span><img src="https://cdn.simpleicons.org/whatsapp/25D366" alt="WhatsApp" className="wa-hero-icon" /></span></span></h1>
